...
class EvaluateAnswerNode:
    ...
    async def __call__(self, state: AgentState) -> AgentState:
        logger.info("entering node=evaluate_answer")
        result = await self.tools.generate_action_response(state, action="evaluate_answer")
        return {
            ...
            "workflow_trace": append_trace(state, "evaluate_answer"),
        }
